...
export class Convert {
    public static toShow(json: string): Show {
        return cast(JSON.parse(json), r("Show"));
    }

    public static showToJson(value: Show): string {
        return JSON.stringify(uncast(value, r("Show")), null, 2);
    }
}
