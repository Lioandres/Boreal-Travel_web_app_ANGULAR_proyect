// To parse this data:
//
//   import { Convert, Temps } from "./file";
//
//   const temps = Convert.toTemps(json);
//
...
export class Convert {
    public static toTemps(json: string): Temps {
        return cast(JSON.parse(json), r("Temps"));
    }

    public static tempsToJson(value: Temps): string {
        return JSON.stringify(uncast(value, r("Temps")), null, 2);
    }
}
